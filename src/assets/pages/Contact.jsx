          ...
          <form>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <input
                ...
                className="px-4 py-2 rounded-lg border dark:bg-gray-800 dark:text-white dark:border-none   focus:outline-none focus:ring-2 focus:ring-but"
                required
              />
            </div>
            <input
              type="text"
              placeholder="Subject"
              className="w-full px-4 py-2 dark:bg-gray-800 dark:text-white dark:border-none  rounded-lg border focus:outline-none focus:ring-2 focus:ring-but mt-4"
              required
            />
            <textarea
