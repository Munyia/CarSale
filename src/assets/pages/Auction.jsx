      ...
      {selectedCar && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg max-w-sm w-full">
            ...
            />
            {error && <p className="text-red-500 mb-4">{error}</p>} {/* Show error message if present */}
            {message && <p className="text-green-500 mb-4">{message}</p>} {/* Show success message if present */}
