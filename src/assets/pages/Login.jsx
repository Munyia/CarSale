        ...
        <div className="max-w-md mx-auto">
          ...
          <form className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <div className="col-span-2 mt-5">
              <button
                className="py-2 px-4 hover:bg-blue-500 focus:ring-blue-200 focus:ring-offset-blue-400  w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                type="submit"
              >
            ...
            <div className="col-span-2 mt-5">
              <button
                className="py-2 px-4 bg-blue-900 hover:bg-blue-500 focus:ring-blue-200 focus:ring-offset-blue-400 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                type="submit"
              >
                Login
              </button>
